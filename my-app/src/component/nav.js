  ...
  return (
    <div className="flex justify-between items-center p-4 bg-white shadow-md">
      <div className="flex items-center">
        <img src="https://s3-alpha-sig.figma.com/img/4331/41bc/8c7a66505619b246757b0e023183dbb2?Expires=1722816000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=JTQd8oCBIYIX4qmRSwXI6UvH97rYgDvD5vER7Rv9YG1CsdMQStk1wLTgXNx36OQqTPqJEVWmUXxj6SFxmkYvt14SeTKrZCUk0L8IFdTqXauv2KwaaENr9OGzBNxBFyTrgMHSVTVf5Sxqy3SPEfPv3kyY1lCET3J~XBuoBO3ZInBbAAbV2Wg0LlaUcfd-9vqa-bLC6sw1n4Klr0WVV5060EM4b7bIRR701W~26z3CeEOe711Z3zv7Pa9U-ofq0UUIfcjclU8NwMSnWLXSdjRBw1kG70c7uW0ZZI~rIgmaWCr9frmybLSixH7dN7uPTuMLXpMKYQOpG9zWfoaa2oIGhg__" alt="Swoo Logo" className="h-10 mr-2" />
        <div>
      ...
      <div className="flex items-center space-x-6">
        <div className="relative group">
          ...
          <div className="absolute hidden group-hover:block bg-white shadow-md mt-2 rounded-md">
            <button className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100">Option 1</button>
            <button className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100">Option 2</button>
          </div>
        </div>
        <div className="relative group">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="text-right">
          ...
          <button className="text-black font-bold">LOG IN / REGISTER</button>
        </div>
        <div className="flex items-center">
